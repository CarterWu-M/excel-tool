...
using Excel_Label_tool.Models;
using Excel_Label_tool.Views;

namespace Excel_Label_tool.Controllers
{
    public class ExcelController
    {
        ...
        private ExcelLabelViewHelper _labelViewHelper = null;
        ...
        public ExcelController(IView view)
        {
            ...
            this._view = view;
            this._labelViewHelper = new ExcelLabelViewHelper();
        ...
        private bool isArtNoSupported(string szArtNo)
        {
            for (uint i = 0; arrKTbl.Length > i; i++)
            {
                ...
                {
                    kTblIdx = i;
                    this._labelViewHelper.setCell3High(arrKTbl[kTblIdx].arrCellRowHigh);
                    return true;
                }
            }
            return false;
        ...
        private void View_GenerateReport(object sender, EventArgs e)
        {
            ...
            this._model.szPiezoV = this._view.getPiezoVer(); //for HP
            this._model.szDriverV = this._view.getDeiverVer(); //for HP
        ...
        private void PasteImage(Excel.Worksheet worksheet, int rowStartIdx, int colStartIdx)
        {
            ...
            this._labelViewHelper.setBottomLine(cell);
        ...
        private void SetExcelLayoutHP(Excel.Worksheet newWorksheet, int rowStartIdx, int colStartIdx, int dataIdx)
        {
            try
            {
                ...
                this._labelViewHelper.setH1(rangeToMerge);
                this._labelViewHelper.setH2(newWorksheet.Cells[rowStartIdx + 1, colStartIdx], "Type:");
                this._labelViewHelper.setC2(newWorksheet.Cells[rowStartIdx + 1, colStartIdx + 1], "US H05");
                this._labelViewHelper.setH2(newWorksheet.Cells[rowStartIdx + 1, colStartIdx + 4], "Date:");
                this._labelViewHelper.setC2(newWorksheet.Cells[rowStartIdx + 1, colStartIdx + 5], _model.szDate);
                this._labelViewHelper.setH2(newWorksheet.Cells[rowStartIdx + 2, colStartIdx], "SN:");
                this._labelViewHelper.setC2(newWorksheet.Cells[rowStartIdx + 2, colStartIdx + 1], _model.arrDataTable[0].Rows[dataIdx - 1][1].ToString());
                this._labelViewHelper.setH2(newWorksheet.Cells[rowStartIdx + 2, colStartIdx + 4], "Inspector:");
                this._labelViewHelper.setC2(newWorksheet.Cells[rowStartIdx + 2, colStartIdx + 5], _model.szInspector);
                // interval ======================================
                this._labelViewHelper.setInterval(newWorksheet.Cells[rowStartIdx + 3, colStartIdx]);
                // header ========================================
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "US cup surface");
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "Finishing housing");
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "Finishing gluing");
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "Batch      label");
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "Water proofness");
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "LED indication");

                // content ===================================
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 6, colStartIdx], STR_OK);
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 6, colStartIdx + 1], STR_OK);
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 6, colStartIdx + 2], STR_OK);
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 6, colStartIdx + 3], STR_OK);
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 6, colStartIdx + 4], STR_PASS);
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 6, colStartIdx + 5], STR_PASS);
                // interval =================================
                this._labelViewHelper.setInterval(newWorksheet.Cells[rowStartIdx + 7, colStartIdx]);
                // header ===================================
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "Piezo     board");
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "Driver    board");
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "Output power @2W/cm2");
                this._labelViewHelper.setH3(newWorksheet.Cells[rowStartIdx + 9, colStartIdx + 2], "1MHz");
                this._labelViewHelper.setH3(newWorksheet.Cells[rowStartIdx + 9, colStartIdx + 3], "3MHz");
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "Contact control");
                this._labelViewHelper.setH3(newWorksheet.Cells[rowStartIdx + 9, colStartIdx + 4], "1MHz");
                this._labelViewHelper.setH3(newWorksheet.Cells[rowStartIdx + 9, colStartIdx + 5], "3MHz");
                // content ================================
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 10, colStartIdx], _model.szPiezoV);
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 10, colStartIdx + 1], _model.szDriverV);
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 10, colStartIdx + 2], float.Parse((string)_model.arrDataTable[0].Rows[dataIdx - 1][8]).ToString("F2") + " W");
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 10, colStartIdx + 3], float.Parse((string)_model.arrDataTable[0].Rows[dataIdx - 1][9]).ToString("F2") + " W");
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 10, colStartIdx + 4], STR_PASS);
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 10, colStartIdx + 5], STR_PASS);
                // interval =============================
                this._labelViewHelper.setInterval(newWorksheet.Cells[rowStartIdx + 11, colStartIdx]);
                // sign =================================
        ...
        private int parseDataUSC()
        {
            for (int i = 1; 2 >= i; i++)
            {
                ...
                if (null == _model.arrDataTable[1])
                {
                    _model.arrDataTable[1] = new System.Data.DataTable();
                }
        ...
        private void SetExcelLayoutUSC(Excel.Worksheet newWorksheet, int rowStartIdx, int colStartIdx, int[] arrDataIdx)
        {
            try
            {
                ...
                this._labelViewHelper.setH1(rangeToMerge);
                this._labelViewHelper.setH2(newWorksheet.Cells[rowStartIdx + 1, colStartIdx], "Type:");
                this._labelViewHelper.setC2(newWorksheet.Cells[rowStartIdx + 1, colStartIdx + 1], "US compact");
                this._labelViewHelper.setH2(newWorksheet.Cells[rowStartIdx + 1, colStartIdx + 4], "Date:");
                this._labelViewHelper.setC2(newWorksheet.Cells[rowStartIdx + 1, colStartIdx + 5], _model.szDate);
                this._labelViewHelper.setH2(newWorksheet.Cells[rowStartIdx + 2, colStartIdx], "SN:");
                this._labelViewHelper.setC2(newWorksheet.Cells[rowStartIdx + 2, colStartIdx + 1], _model.arrDataTable[0].Rows[arrDataIdx[0] - 1][1].ToString());
                this._labelViewHelper.setH2(newWorksheet.Cells[rowStartIdx + 2, colStartIdx + 4], "Inspector:");
                this._labelViewHelper.setC2(newWorksheet.Cells[rowStartIdx + 2, colStartIdx + 5], _model.szInspector);
                // interval =======================================
                this._labelViewHelper.setInterval(newWorksheet.Cells[rowStartIdx + 3, colStartIdx]);
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "RTC         test");
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "EEPROM test");
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "Power  button        test");
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "LCD touch pannel test");
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "LCD color patern test");
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "LCD backlight test");
                // content1 =======================================
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 7, colStartIdx], STR_PASS);
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 7, colStartIdx + 1], STR_PASS);
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 7, colStartIdx + 2], STR_PASS);
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 7, colStartIdx + 3], STR_PASS);
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 7, colStartIdx + 4], STR_PASS);
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 7, colStartIdx + 5], STR_PASS);
                // interval =======================================
                this._labelViewHelper.setInterval(newWorksheet.Cells[rowStartIdx + 8, colStartIdx]);
                // header2 ========================================
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "USB port   test");
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "Handpiece port test");
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "Speaker    test");
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "Discharging White");
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "Charging Green");
                this._labelViewHelper.setH3(newWorksheet.Cells[rowStartIdx + 9, colStartIdx + 5], "Burn-in");
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "Battery (Dis)");
                // content2 =======================================
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 12, colStartIdx], STR_PASS);
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 12, colStartIdx + 1], STR_PASS);
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 12, colStartIdx + 2], STR_PASS);
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 12, colStartIdx + 3], STR_PASS);
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 12, colStartIdx + 4], STR_PASS);
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 12, colStartIdx + 5], STR_PASS);
                // interval =======================================
                this._labelViewHelper.setInterval(newWorksheet.Cells[rowStartIdx + 13, colStartIdx]);
                // header3 ========================================
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "Mains On Applied part (MAP test)");
                ...
                rangeToMerge.Merge();
                this._labelViewHelper.setH3(rangeToMerge, "Leakage Current test");
                this._labelViewHelper.setH3(newWorksheet.Cells[rowStartIdx + 15, colStartIdx], "NC");
                this._labelViewHelper.setH3(newWorksheet.Cells[rowStartIdx + 15, colStartIdx + 1], "NC reverse");
                this._labelViewHelper.setH3(newWorksheet.Cells[rowStartIdx + 15, colStartIdx + 2], "SFC");
                this._labelViewHelper.setH3(newWorksheet.Cells[rowStartIdx + 15, colStartIdx + 3], "NC");
                this._labelViewHelper.setH3(newWorksheet.Cells[rowStartIdx + 15, colStartIdx + 4], "NC reverse");
                this._labelViewHelper.setH3(newWorksheet.Cells[rowStartIdx + 15, colStartIdx + 5], "Result");
                // content3 =======================================
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 16, colStartIdx], float.Parse((string)_model.arrDataTable[1].Rows[arrDataIdx[1] - 1][4 - 1]).ToString("F2") + " uA");
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 16, colStartIdx + 1], float.Parse((string)_model.arrDataTable[1].Rows[arrDataIdx[1] - 1][5 - 1]).ToString("F2") + " uA");
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 16, colStartIdx + 2], float.Parse((string)_model.arrDataTable[1].Rows[arrDataIdx[1] - 1][6 - 1]).ToString("F2") + " uA");
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 16, colStartIdx + 3], float.Parse((string)_model.arrDataTable[1].Rows[arrDataIdx[1] - 1][2 - 1]).ToString("F2") + " uA");
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 16, colStartIdx + 4], float.Parse((string)_model.arrDataTable[1].Rows[arrDataIdx[1] - 1][3 - 1]).ToString("F2") + " uA");
                this._labelViewHelper.setC3(newWorksheet.Cells[rowStartIdx + 16, colStartIdx + 5], STR_PASS);
                // interval =======================================
                this._labelViewHelper.setInterval(newWorksheet.Cells[rowStartIdx + 17, colStartIdx]);
                // sign ===========================================
